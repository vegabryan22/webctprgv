...
| 2026-07-27 | Contacto institucional parametrizable | 0.28.0 | Completado | `20b9656` | Pendiente | 76 pruebas y 461 aserciones aprobadas; migración local y `/contacto` con HTTP 200 | Canales, ubicación y verificación editables; formulario inactivo retirado |
