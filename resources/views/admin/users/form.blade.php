...
@section('content')
<div class="page-heading"><h1>{{ $user->exists ? 'Editar usuario' : 'Nuevo usuario' }}</h1><a href="{{ route('admin.users.index') }}">Volver</a></div>
...
<button class="button secondary" type="submit">Guardar usuario</button></form>
@endsection
