...
@section('content')
<div class="page-heading"><div><h1>Roles y permisos</h1><p class="muted">Defina responsabilidades sin otorgar acceso innecesario.</p></div>@if(auth()->user()->hasPermission('roles.manage'))<a class="button" href="{{ route('admin.roles.create') }}">Nuevo rol</a>@endif</div>
