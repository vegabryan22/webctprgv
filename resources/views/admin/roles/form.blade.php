...
@section('content')
<div class="page-heading"><h1>{{ $role->exists ? 'Editar rol' : 'Nuevo rol' }}</h1><a href="{{ route('admin.roles.index') }}">Volver</a></div>
...
<button class="button secondary" type="submit">Guardar rol</button></form>
@endsection
