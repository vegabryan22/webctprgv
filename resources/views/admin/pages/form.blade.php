...
@section('content')
<div class="page-heading"><h1>{{ $page->exists ? 'Editar página' : 'Nueva página' }}</h1><a href="{{ route('admin.pages.index') }}">Volver</a></div>
...
<button class="button secondary" type="submit">Guardar página</button></form>
@endsection
