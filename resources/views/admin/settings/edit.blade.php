...
@section('content')
<div class="page-heading"><div><h1><i class="fa-solid fa-sliders"></i> Configuración del sitio</h1><p class="muted">Datos institucionales reutilizables en el contenido.</p></div></div>
...
<button class="button secondary" type="submit"><i class="fa-solid fa-floppy-disk"></i> Guardar configuración</button></form>
@endsection
