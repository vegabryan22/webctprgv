...
<div class="admin-shell">
    <aside class="sidebar">
        ...
        <nav>
            ...
            @if(auth()->user()->hasPermission('pages.view') || auth()->user()->hasPermission('news.view') || auth()->user()->hasPermission('services.view') || auth()->user()->hasPermission('specialties.view') || auth()->user()->hasPermission('workshops.view') || auth()->user()->hasPermission('directory.view') || auth()->user()->hasPermission('documents.view') || auth()->user()->hasPermission('experiences.view') || auth()->user()->hasPermission('menu.view') || auth()->user()->hasPermission('events.view'))
