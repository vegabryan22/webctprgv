...
class CmsContentTest extends TestCase
{
    ...
    {
        $this->assertSame(8, ContentPage::where('is_system', true)->count());
        $this->assertSame(10, NavigationItem::count());
        ...
        $this->assertDatabaseHas('navigation_items', ['route_name' => 'admission', 'label' => 'ADMISIÓN']);
